...
#
# Example:
#   PRE=conll16st-v3400 PREDIR=/srv/storage/conll16st MEM=24000M DOCKER_ARGS="-m $MEM --memory-swap $MEM -v $PREDIR/data:/srv/data -v $PREDIR/ex:/srv/ex"
#   DATAT=en-train DATAV=en-dev DATAX=en-trial CONFIG=''
...
#
#   NAME=$PRE-2-$DATAT
#   docker run -d $DOCKER_ARGS --name $NAME $PRE ./v33/train.py ex/$NAME data/conll16st-$DATAT data/conll16st-$DATAV --clean --config="{\"focus_dim\":\"2\", $CONFIG}" && echo -ne "\ek${NAME:10}\e\\" && sleep 5 && less +F $PREDIR/ex/$NAME/console.log
#     docker logs -f $NAME
#     docker rm -f $NAME
...
#CMD ["/srv/v33/train.py", "ex/v3300", "data/conll16st-en-trial", "data/conll16st-en-trial", "--clean"]
